...
class GEFSTasks(Tasks):
    ...
    def postsnd(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/postsnd.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def gempak(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': postenvars,
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/gempak.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def awips(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': postenvars,
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/awips.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'}
    ...
    def wave_stat(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/wave_stat.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def wave_stat_pnt(self):
        ...
        resources = self.get_resource('wave_stat_pnt')
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'envars': self.envars,
                     'cycledef': self.run,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/wave_stat_pnt.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
    ...
    def globus(self):
        ...
        task_dict = {'task_name': task_name,
                     ...
                     'cycledef': self.run,
                     'dependency': dependencies,
                     'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/globus_arch.sh',
                     'job_name': f'{self.pslot}_{task_name}_@H',
                     'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                     'maxtries': '&MAXTRIES;'
                     }
